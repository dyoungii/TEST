...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/IncaKoin-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h
...
windows:RC_FILE = src/qt/res/IncaKoin-qt.rc
...
macx:ICON = src/qt/res/icons/IncaKoin.icns
